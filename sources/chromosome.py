...
class Chromosome:
    ...
    def crossover(self,other):
        ...
        if len(child0) != self.chromosome_size:
            print(f"Error : child size {len(child0)} but {self.chromosome_size} was excepected")
            print(f"\t self size {len(self.actions)} | other size {len(other.actions)}")
            print(f"{self.starting_index} {self.starting_index}")
